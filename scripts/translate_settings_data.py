...
SUBS = [
    ...
    ("We gaan", "we're going"),
    ("viraal", "viral"),
    ('"main_heading": "we gaan"', '"main_heading": "we\'re going"'),
    ('"main_heading": "We gaan"', '"main_heading": "we\'re going"'),
    ('"sub_heading": "viraal"', '"sub_heading": "viral"'),
    ("gezien op TikTok", "AS SEEN ON TIKTOK"),
    ...
    ("Producten", "Products"),
    ("Voetbal", "Football"),
    # Word-boundary-safe: avoid matching inside "Basketball" / "Volleyball"
    ("Basketbal ", "Basketball "),
    ("Volleybal ", "Volleyball "),
    ('"Basketbal"', '"Basketball"'),
    ('"Volleybal"', '"Volleyball"'),
    ("shop_images/Basketbal", "shop_images/Basketball"),
    ("shop_images/Volleybal", "shop_images/Volleyball"),
