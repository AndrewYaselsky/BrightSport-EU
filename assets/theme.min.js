          ...
          },
          {
            ...
            value: function () {
              return window.matchMedia("screen and (max-width: 640px)").matches
                ...
                ? "tablet"
                : window.matchMedia("screen and (min-width: 1008px) and (max-width: 1279px)")
                    .matches
                ? "lap"
        ...
        _createClass(e, [
          {
            ...
            value: function (e, t) {
              ...
              if (
                ...
                t.getAttribute("data-image-id") !== a.getAttribute("data-image-id")
              ) {
          ...
          _createClass(e, null, [
            ...
            },
            {
              ...
              value: function (e) {
                ...
                i["default"]
                  .nodeListToArray((e || document).querySelectorAll("[data-money-convertible]"))
                  .forEach(function (e) {
                    if (
                      ...
                      if (e.hasAttribute("data-currency-" + o))
                        ...
                        var r = window.Currency.convert(
                          100 * parseFloat(i.replace(/^[^0-9]+|[^0-9.]/g, "", ""), 10),
                          a,
                          o
                        );
          ...
          return (
            _createClass(e, [
              ...
              },
              {
                ...
                //   if (this.element.id === "sidebar-cart") {
                //     document.addEventListener("maison:openCart", () => this.open());
                //     document.addEventListener("maison:closeCart", () => this.close());
                //   }
                },
              },
              {
      ...
      s = (function () {
        function e(t, n) {
          _classCallCheck(this, e),
            ...
            (this.activator =
              n.activator ||
              document.querySelector('[aria-controls="' + t.getAttribute("id") + '"]')),
              ...
              value: function () {
                ...
                fastdom.measure(function () {
                  ...
                  if ("bottom" === e.preferredPosition)
                    (a = "right"),
                      (i =
                        e.element.clientHeight <= s - (r.bottom + o) || s - r.bottom >= l
                          ? "bottom"
                          : "top");
                  ...
                  fastdom.mutate(function () {
                    [
                      ...
                      e.element.classList.add(
                        "Popover--position" + (i.charAt(0).toUpperCase() + i.slice(1))
                      ),
                      e.element.classList.add(
                        "Popover--align" + (a.charAt(0).toUpperCase() + a.slice(1))
                      ),
                      e.element.setAttribute(
                        "style",
                        "bottom: " + parseInt(t) + "px; right: " + parseInt(n) + "px;"
                      );
                  });
              },
            },
                    ...
                    e.compare_at_price > e.price
                      ? ((n.innerHTML +=
                        ...
                        (n.innerHTML +=
                          ...
                          s["default"].formatMoney(e.compare_at_price, window.theme.moneyFormat) +
                          "</span>"))
                      : (n.innerHTML +=
              ...
              value: function (e, t, n) {
                ...
                (i.innerHTML = e),
                  a &&
                    ...
                    (window.CSS &&
                      window.CSS.supports(
                        "background-color: " + t.getAttribute("data-background-color")
                      ))
                ...
                if (!o["default"].matchesBreakpoint("pocket")) {
                  ...
                  i["default"].getSiblings(t, null, !0).forEach(function (e) {
                    ...
                    this._createPhotoSwipeInstance(
                      ...
                      parseInt(t.getAttribute("data-image-position-ignoring-video"))
                    );
                }
              },
            },
                          ...
                          (l +=
                            ...
                            r.forEach(function (e) {
                              l +=
                                ...
                                e.name +
                                ": " +
                                a["default"].formatMoney(e.price, window.theme.moneyFormat) +
                                "</li>";
                            }),
                            (l += "</ul>"),
            ...
            },
            {
              ...
              value: function (e) {
                ...
                n &&
                  ...
                  (t.setAttribute("aria-expanded", "true"), i["default"].slideDown(n));
              },
            },
            {
              key: "_close",
              value: function (e) {
                ...
                n &&
                  ...
                  (t.setAttribute("aria-expanded", "false"), i["default"].slideUp(n));
              },
            },
          ]),
          e
    ...
    var i = n(6),
      ...
      o = function s() {
        ...
        _classCallCheck(this, s),
          ...
          i.DomHelper.nodeListToArray(document.querySelectorAll(".Modal--address")).forEach(
            function (t) {
              ...
              value: function (e) {
                ...
                e.forEach(function (e) {
                  (e.isIntersecting || e.intersectionRatio > 0) &&
                    (n.push(e.target), t.intersectionObserver.unobserve(e.target));
                }),
                  0 !== n.length &&
              ...
              value: function () {
                ...
                fastdom.measure(function () {
                  (t = window.pageYOffset),
                    ...
                    e.articleNavElement &&
                      (i = e.articleNavElement.offsetTop + e.articleNavElement.clientHeight - n);
                }),
                  fastdom.mutate(function () {
              ...
              value: function () {
                ...
                if (
                  ...
                  (this.element.querySelector(".Cart__NoteButton").innerHTML =
                    "" !== n.value ? window.languages.cartEditNote : window.languages.cartAddNote),
                  t.setAttribute(
                    "aria-hidden",
...
//                 setTimeout(function(){
//                   // var currentTotalss = $(".Drawer__Footer .total_price").text();
//                   var currentTotalss = $(".total_price_checkout span.total_price.Heading").text();
//                   console.log(currentTotalss);  
//                   var currentTotal = parseFloat(currentTotalss.replace(/[^0-9.]/g, ''));
...
//                    setTimeout(function(){
//                    var per = $(".progress-value").css("width", percentage + "%");
...
//                   // $(".progress-value").css("width", percentageString);

                  

// //                   var percentagess = percentage + "%"; // Add a percentage sign to the value
// //                   console.log(percentagess);
// // // Use jQuery to update the style attribute of the element with class "aa"
// // $(".progress .progress-value").css("width", percentagess);
...
//                 }, 800);
    ...
    // Remove the last product (assuming you have code to do this)
    // After removing the last product, call the updateProgressBar function
    setTimeout(function () {
      // Code to remove the last product goes here
      ...
      updateProgressBar();
            ...
            },
            {
              ...
              value: function (e) {
                ...
                if (this.options.drawer) {
                  ...
                  0 === this.itemCount
                    ? (this.element.innerHTML =
                        t.querySelector(".shopify-section").firstElementChild.innerHTML)
                    : (n.replaceChild(
                ...
                const sidebarCart = t.querySelector('#sidebar-cart');
                const sidebarCartSettings = JSON.parse(sidebarCart.dataset.sectionSettings);
                const n2 = a["default"].nodeListToArray(document.querySelectorAll(".Header__CartDot"));
                const i2 = a["default"].nodeListToArray(document.querySelectorAll(".Header__CartCount"));
                n2.forEach(function (e) {
                  0 === sidebarCartSettings.itemCount
                    ? e.classList.remove("is-visible")
                    : e.classList.add("is-visible");
                }),
                i2.forEach(function (e) {
                  e.textContent = sidebarCartSettings.itemCount;
                });
              },
            },
            {
              /* custom added */
              key: "_onCollectionProductAdded",
              value: function (e) {
                var t = this;
                this._rerenderCart().then(function () {
                  t.sidebarDrawer.open();
            ...
            },
            {
              ...
              value: function (e) {
                ...
                if (
                  t &&
                  t.featured_image &&
                  (!n.featured_image || n.featured_image.id !== t.featured_image.id)
                ) {
                  var i = t.featured_image,
                    o = this.element.querySelector(".FeaturedProduct__Gallery .AspectRatio");
                  o.style.cssText =
                    "max-width: " + i.width + "px; --aspect-ratio: " + i.width / i.height;
                  var s = document.createElement("img");
                  s.classList.add("Image--lazyLoad"),
                    s.setAttribute(
                      "data-src",
                      a["default"].getSizedImageUrl(i.src, "1x1").replace("_1x1.", "_{width}x.")
                    ),
                    s.setAttribute(
                      "data-widths",
                      "[" +
                        a["default"]
                          .getSupportedSizes(i, [200, 400, 600, 700, 800, 900, 1e3])
                          .join(",") +
                        "]"
                    ),
              ...
              value: function () {
                ...
                fastdom.mutate(function () {
                  i["default"]
                    ...
                    i["default"]
                      .nodeListToArray(e.element.querySelectorAll('[aria-hidden="false"]'))
                      .forEach(function (e) {
                        e.setAttribute("aria-hidden", "true");
                      });
                }),
                  ...
                  fastdom.mutate(function () {
                    t.classList.add("is-expanded"),
                      ...
                      i["default"].getSiblings(t, ".is-expanded").forEach(function (e) {
                        e.classList.remove("is-expanded"),
                          i["default"]
                            .nodeListToArray(e.children, '[aria-hidden="false"]')
                            .forEach(function (e) {
                              e.setAttribute("aria-hidden", "true");
                            });
                      });
                  ...
                  (this.mainMenuWidth = 45),
                    ...
                    fastdom.measure(function () {
                      (e.menuLeftOffset = t.offsetLeft),
                        i["default"]
                          .nodeListToArray(t.querySelectorAll(".HorizontalList__Item"))
                          .forEach(function (t) {
              ...
              value: function () {
                ...
                fastdom.measure(function () {
                  t =
                    e.mainMenuWidth >
                    Math.ceil(
                      e.element.querySelector(".Header__Logo").offsetLeft - e.menuLeftOffset
                    );
                }),
                  fastdom.mutate(function () {
                    t
      ...
      d = (function () {
        function e(t) {
          ...
          n &&
            ...
            (this.productInfoElement = this.element.querySelector(".Product__Info2")),
            ...
            },
            {
              ...
              value: function (e) {
                ...
                if (
                  t &&
                  t.featured_image &&
                  (!n || !n.featured_image || n.featured_image.id !== t.featured_image.id)
                )
              ...
              value: function (e) {
                this.slideshowNavDotsItems.forEach(function (e) {
                  ...
                  this.slideshowNavDotsItems[
                    parseInt(e.detail.newTarget.getAttribute("data-image-position"))
                  ...
                  if ("phone" === t || "tablet" === t)
                    ...
                    this.productAsideElement
                      ? ((this.productAsideElement.style.minHeight =
                        ...
                        (this.productInfoElement.closest(".Product__InfoWrapper").style.maxHeight =
                          this.productAsideElement.offsetTop +
                          this.productInfoElement.scrollHeight -
                          o +
                          "px"))
                      : (this.productWrapperElement.style.minHeight =
                          this.productInfoElement.scrollHeight - parseInt(a.paddingTop) + "px"),
          ...
          _createClass(e, [
            ...
            },
            {
              ...
              value: function () {
                ...
                "" !== t &&
                  fetch("/search?view=recently-viewed-products&type=product&q=" + t, {
                    credentials: "same-origin",
                    method: "GET",
                  }).then(function (t) {
                    t.text().then(function (t) {
            ...
            },
            {
              ...
              value: function (e) {
                ...
                fastdom.measure(function () {
                  var i =
                      window.innerWidth /
                      (n.offsetWidth - 2 * parseInt(window.getComputedStyle(n).paddingLeft)),
                  ...
                  (t._calculateTransformForDotListener = function (e) {
                    var n = Math.round(
                        (e.detail.dot.offsetTop + e.detail.dot.offsetHeight / 2) * i
                      ),
                      a = Math.round(n - s / 2),
                      o = Math.min(Math.max(r - a, l), r);
                    fastdom.mutate(function () {
                      t.outerCarousel.flickityInstance.viewport.style.transform =
                        "translate3d(0, " + Math.round(o) + "px, 0) scale(" + i + ")";
                    });
                  }),
  ...
  function (e, t, n) {
    ...
    !(function () {
      ...
      !(function () {
        ...
        (function () {
          a.DomHelper.nodeListToArray(document.querySelectorAll(".Rte table")).forEach(function (
            e
          ) {
            e.outerHTML = '<div class="TableWrapper">' + e.outerHTML + "</div>";
          }),
            a.DomHelper.nodeListToArray(document.querySelectorAll(".Rte iframe")).forEach(function (
              e
            ) {
...
if ($(window).width() < 1200) {
  ...
  $(".ProductItem button#ad_to_cart").click(function(e){
    e.preventDefault();
    e.stopPropagation();
    e.stopImmediatePropagation();

    var id = $(this).data('var_id');
    var qty = 1;
        ...
        success: function(){
         ...
         // this.options.drawer();
           // drawer();
            ...
            // if (drawer) {
            //     drawer.classList.add('open'); // Apply the appropriate class to open the drawer
            // }
            ...
            // if (cartDrawer) {
            //     cartDrawer.classList.add('open'); // Add a CSS class to display the drawer
            //     console.log("yes");
            // }
        },
        error: function(){}
  ...
  // $(".bundle_function_col").each(function() {
  //   var totalSum = 0;

  //   $(this).find(".bundle_function_box").each(function() {
  //     var vals = $(this).find('input[name="product_price[]"]').val();
  //     if (vals) {
  //       totalSum += parseFloat(vals);
  //     }
  //   });

  //   // Convert the totalSum back to euros and cents format (e.g., €5.95)
  //   var formattedTotalSum = (totalSum / 100).toFixed(2);
  //   $(this).find("p#totalPrice").text('Total value: €' + formattedTotalSum);
  // });
  ...
  //   $(this).find(".bundle_function_box").each(function() {
  //     var vals = $(this).find('input[name="product_discount_price[]"]').val();
  //     if (vals) {
  //       totalSum += parseFloat(vals);
  //     }
  //   });
  ...
  //   // Convert the totalSum back to euros and cents format (e.g., €5.95)
  //   var formattedTotalSum = (totalSum / 100).toFixed(2);
  //   $(this).find("p#totaldicountprice").text(' €' + formattedTotalSum);
  // });
  ...
  $(document).ready(function() {
      ...
      //     var mainPriceSpan = $(this);
      //     var value = mainPriceSpan.text().trim();
      //     var parts = value.split(",");
          
      //     var span1 = $('<span>').text(parts[0]);
      //     var span2 = $('<span>').text(parts[1]);

      //     mainPriceSpan.empty();
      //     mainPriceSpan.append(span1);
      //     mainPriceSpan.append(span2);
      // });
    
      $(".btns_cart").click(function(){
            $(".bundle_function_box .add_to_cart").removeClass("active");
            $(this).parents(".bundle_function_col").find(".bundle_function_box").each(function(){
              $(this).find(".add_to_cart").addClass("active");
            });      

      var variantIDs = [];
      
          $(".bundle_function_box .add_to_cart.active").each(function(){
              variantIDs.push($(this).find('input[name="id"]').val());
          });
...
$(document).ready(function(){
$(".QuantitySelector__Button.minus_btn").click(function(e){
  e.preventDefault();
  // e.stopPropagation();
  // e.stopImmediatePropagation();
...
//     $(".ProductMeta__PriceList .percentage_price_col .product_prices").text(formattedSum);
// });
